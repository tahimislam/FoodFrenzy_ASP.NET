<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="FoodFrenzy.User.Registration" %>
                    ...
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control"
                                placeholder="Enter Email Address" ToolTip="Email" TextMode="Email"></asp:TextBox>
