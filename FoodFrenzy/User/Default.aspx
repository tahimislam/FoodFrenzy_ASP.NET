<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="FoodFrenzy.User.Default" %>
<%@ Import Namespace="FoodFrenzy" %>
        ...
        <div class="col-md-6">
          <div class="detail-box">
            <div class="heading_container">
              <h2>
                We Are Food<span style="color:#ffbe33;">Frenzy</span>
              </h2>
            </div>
            <p>
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                  The diverse menu options, prompt delivery, 
                   and excellent packaging ensured that I enjoyed a 
                   delicious meal in the comfort of my own home. Highly recommended!
                </p>
                <h6>
                  Tahim Islam
                </h6>
